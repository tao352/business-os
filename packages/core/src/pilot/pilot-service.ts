 ...
 * Never uses static hardcoded credentials.
 */
export async function provisionPilotOrganization(
  ...
  const isAutoGenerated = !input.ownerPassword;
  const initialPassword =
    input.ownerPassword ||
    `P!lot_${crypto.randomBytes(12).toString("base64url")}#9`;
  ...
  return {
    ...
    context: tenantContext,
    oneTimeSetupSecret: isAutoGenerated ? initialPassword : undefined,
  };
}
